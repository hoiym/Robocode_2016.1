...
public class TonyStank extends TeamRobot
{
	//Field Specification
	...
	*/
	...
	public void onScannedRobot(ScannedRobotEvent e)
	{
		...
		if((firstScan == 1) && (e.getEnergy() == 200))
		{
			firstScan = 0;
			name = e.getName();
		}
		else if((firstScan == 1) && (e.getEnergy() != 200))
		{
			return;
		}
		else if((firstScan == 0) && ((name != e.getName()) && (name != "")))
		{
			return;
		}
		...
		//Squaring
	 	setTurnRight(normalBearing(e.getBearing() + 90));
